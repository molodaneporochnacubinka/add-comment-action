...
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(7774);
...
try {
    ...
    const ticketId = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('ticket-id');
    const xOrgId = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('x-org-id');
    const token = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('token');
    const comment = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('comment');
  ...
  const response = await (0,node_fetch__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(url, options);
...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(6442))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(3146);
...
var node_domexception = __nccwpck_require__(4673);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(8691);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require__(3146);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(3056);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(3146);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(8691);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 429).then(__nccwpck_require__.bind(__nccwpck_require__, 2429));
...
var from = __nccwpck_require__(4989);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(5034);
